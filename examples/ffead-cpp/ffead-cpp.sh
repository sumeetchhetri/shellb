...
function do_start() {
	...
	set_src "src/modules" "stared:ffead-modules"
	set_src "src/framework" "stared:ffead-framework" "ffead-modules"
	...
	set_inc_src "web/default/include" "web/default/src" "stared:default" "ffead-framework,ffead-modules"
	set_inc_src "web/flexApp/include" "web/flexApp/src" "stared:flexApp" "ffead-framework,ffead-modules"
	set_inc_src "web/markers/include" "web/markers/src" "stared:markers" "ffead-framework,ffead-modules"
	set_inc_src "web/oauthApp/include" "web/oauthApp/src" "stared:oauthApp" "ffead-framework,ffead-modules"
	set_inc_src "web/peer-server/include" "web/peer-server/src" "stared:peer-server" "ffead-framework,ffead-modules"
	set_inc_src "web/te-benchmark/include" "web/te-benchmark/src" "stared:te-benchmark" "ffead-framework,ffead-modules"
	set_inc_src "web/t1/include" "web/t1/src" "stared:t1" "ffead-framework,ffead-modules"
	if is_config "MOD_SDORM_MONGO"; then
		set_inc_src "web/t2/include" "web/t2/src" "stared:t2" "ffead-framework,ffead-modules"
	fi
	if is_config "MOD_SDORM_SQL"; then
		set_inc_src "web/t3/include" "web/t3/src" "stared:t3" "ffead-framework,ffead-modules"
		set_inc_src "web/t4/include" "web/t4/src" "stared:t4" "ffead-framework,ffead-modules"
		set_inc_src "web/t5/include" "web/t5/src" "stared:t5" "ffead-framework,ffead-modules"
	fi
