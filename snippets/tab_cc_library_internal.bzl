#Copied from https://github.com/Bazel-snippets/custom_cc_library
...
load(":debug.bzl", "describe")
load("@bazel_tools//tools/cpp:toolchain_utils.bzl", "find_cpp_toolchain")
load("@rules_cc//cc:defs.bzl", "cc_library")
load("@bazel_skylib//lib:paths.bzl", "paths") 
load(":tab_cc_helpers_internal.bzl", "static_lib_to_linking_context", "filter_attributes")
load(":attribute_manipulations.bzl", "location", "add_to_list_attribute")
...
def _tab_cc_library_internal_rule_impl(ctx):
    ...
    #describe(compilation_outputs.objects, 'compilation_outputs (%s)' % ctx.label)
